...
\subsection{Bibliography: use of et al.}
Journal style does not allow ``et al.'' in the reference list unless a reference
has more than 9 authors. Please check the original source and provide the full
author list if there are 9 or fewer authors, or the first 9 authors followed by
``et al.'' if there are more than 9 authors.
...
%%                  The Bibliography                       %%
%%                                                         %%
%%  spr-ims-nameyear.bst  will be used to                  %%
...
%%                                                         %%
%%  List all authors when there are 9 or fewer;            %%
%%  use "et al." starting at 10 authors.                   %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% if your bibliography is in bibtex format, uncomment commands:
%\bibliographystyle{spr-ims-nameyear} % Style BST file
...
Probability Measures}, 2nd ed. New York: Wiley.

\bibitem[\protect\citeauthoryear{Ball}{2001}]{r2}
Ball, K. (2001). Convex geometry and functional analysis. In \textit{Handbook of the Geometry of Banach Spaces}
(W. B. Johnson and J. Lindenstrauss, eds.) 161--194. Amsterdam: North-Holland.
...
theory. \textit{Theory of Probability and Its Applications},
\textbf{1}, 157--214.
