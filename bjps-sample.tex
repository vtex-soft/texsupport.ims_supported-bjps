\documentclass[bjps,preprint]{imsart}
...
\begin{aug}
\author{\fnms{First} \snm{Author}\thanksref{a,t2}\ead[label=e1]{first@somewhere.com}},
\author{\fnms{Second} \snm{Author}\thanksref{b}\ead[label=e2]{second@somewhere.com}}
\and
\author{\fnms{Third} \snm{Author}\thanksref{c}%
...
\affiliation[a]{First Author Short Address}
\affiliation[b]{Second Author Short Address}
\affiliation[c]{Third Author Short Address}
